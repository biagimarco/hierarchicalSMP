...
import it.unifi.hierarchical.model.example.hsmp.HSMP_TwoLevelsExitStates;
import it.unifi.hierarchical.model.example.pn.PN_TwoLevelExitStates;
...
public class Test1 {
    ...
    public void test1() {     
        //HSMP
        //Build the model
        HierarchicalSMP model = HSMP_TwoLevelsExitStates.build();
        ...
        PN_TwoLevelExitStates.build(net, m);
        
        start = new Date();
        RegSteadyState analysisPN = RegSteadyState.builder().build();
        SteadyStateSolution<Marking> ssPN = analysisPN.compute(net, m);
        RewardRate reward1 = RewardRate.fromString("p4");
        RewardRate reward2 = RewardRate.fromString("p3");
        RewardRate reward3 = RewardRate.fromString("If(p0+p1>0,1,0)");
        RewardRate reward4 = RewardRate.fromString("p1");
        RewardRate reward5 = RewardRate.fromString("p0");
