...
public class TestFaultTree {
    ...
    private static final double TIME_STEP = 0.0005;
    private static final double TIME_LIMIT = 6;//Need to be chosen according to the model, based on which is the maximum time elapsed in a region or a state
    private static final double DELTA = 0.001;
    
    private static final Function aFail = new EXP(Variable.X, new BigDecimal("2"));
    private static final Function bFail = new EXP(Variable.X, new BigDecimal("6"));
    private static final Function cFail = new EXP(Variable.X, new BigDecimal("5"));
    private static final Function dFail = new EXP(Variable.X, new BigDecimal("1"));
    
//    private static final Function aFail = GEN.newUniform(new OmegaBigDecimal("2"), new OmegaBigDecimal("5"));
//    private static final Function bFail = GEN.newUniform(new OmegaBigDecimal("0"), new OmegaBigDecimal("5"));
//    private static final Function cFail = GEN.newUniform(new OmegaBigDecimal("1"), new OmegaBigDecimal("5"));
//    private static final Function dFail = GEN.newUniform(new OmegaBigDecimal("0"), new OmegaBigDecimal("5"));
    private static final Function maintenancePeriod = GEN.newDeterministic( new BigDecimal("2"));
    private static final Function repair = GEN.newUniform(new OmegaBigDecimal("4"), new OmegaBigDecimal("6"));
    private static final Function preventiveMaintenance = GEN.newUniform(new OmegaBigDecimal("0"), new OmegaBigDecimal("1"));
    
    @Test
    public void testFaultTree() {
