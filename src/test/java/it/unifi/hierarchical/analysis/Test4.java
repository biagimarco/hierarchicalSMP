...
import it.unifi.hierarchical.model.example.hsmp.HSMP_ManyParallelRegions;
import it.unifi.hierarchical.model.example.pn.PN_ManyParallelRegions;

/**
 * Test to check correctness of analysis when many parallel region exist
 */
public class Test4 {
    ...
    public void test4() {
        ...
        //HSMP
        //Build the model
        HierarchicalSMP model = HSMP_ManyParallelRegions.build();
        ...
        PN_ManyParallelRegions.build(net, m);
        
        start = new Date();
        RegSteadyState analysisPN = RegSteadyState.builder().build();
        SteadyStateSolution<Marking> ssPN = analysisPN.compute(net, m);
        RewardRate reward1 = RewardRate.fromString("S6");
        RewardRate reward2 = RewardRate.fromString("S2");
        RewardRate reward3 = RewardRate.fromString("S4");
        RewardRate reward4 = RewardRate.fromString("S4");
        RewardRate reward5 = RewardRate.fromString("S5");
        RewardRate reward6 = RewardRate.fromString("S6");
        RewardRate reward7 = RewardRate.fromString("S7");
        RewardRate reward8 = RewardRate.fromString("S8");
        SteadyStateSolution<RewardRate> rewardPN = SteadyStateSolution.computeRewards(ssPN, reward1, reward2, reward3, reward4, reward5, reward6, reward7, reward8);
